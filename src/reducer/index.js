...
import addPersonToNewGroup from './addPersonToNewGroup'
import addPersonToCurrentNight from './addPersonToCurrentNight'
import displayAddUser from './displayAddUser'
import displayPastNights from './displayPastNights'
import updateUser from './updateUser'
import userName from './userName'
import userPaying from './userPaying'

module.exports = combineReducers({
	addPersonToCurrentNight,
	addPersonToNewGroup,
	displayAddUser,
	displayPastNights,
	displayRegisterForm,
